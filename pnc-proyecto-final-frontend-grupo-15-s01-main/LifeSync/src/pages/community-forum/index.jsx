...
export default function CommunityForum() {
  const [posts, setPosts] = useState([
    {
      ...
      description: 'Post your favorite meals that balance calories and performance.',
      category: 'Food',
      author: 'Ana García',
      avatar: 'AG',
    ...
    },
    {
      ...
      description: 'How do you use the app to optimize sleep when you have limited hours?',
      category: 'Sleep',
      author: 'Carlos Ruiz',
      avatar: 'CR',
    ...
    },
    {
      ...
      description: 'Discuss how sleep and hydration affect your workout timing.',
      category: 'Training',
      author: 'María López',
      avatar: 'ML',
  ...
  const handleCreatePost = (postData) => {
    const post = {
      ...
      author: 'Usuario',
      avatar: 'U',
      image: postData.imagePreview || 'https://images.unsplash.com/photo-1557683316-973673baf926?w=800',
      likes: 0,
      comments: []
    };
    setPosts([post, ...posts]);
