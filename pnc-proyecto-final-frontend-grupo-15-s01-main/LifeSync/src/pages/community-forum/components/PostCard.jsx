...
export default function PostCard({ post, onClick }) {
  return (
    ...
    >
      ...
      <div className="p-5">
        <span className={`inline-block px-3 py-1 rounded-md text-xs font-semibold mb-3 capitalize ${categoryColors[post.category.toLowerCase()] || 'bg-gray-50 text-gray-700'}`}>
          {post.category}
        </span>
